...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import AMGX_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("656d14af-56e4-5275-8e68-4e861d7b5043"))
platforms = [Pkg.Artifacts.unpack_platform(e, "AMGX", artifacts_toml) for e in artifacts["AMGX"]]
...
if best_platform === nothing
    @debug("Unable to load AMGX; unsupported platform $(triplet(platform_key_abi()))")
else
